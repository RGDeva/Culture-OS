              ...
              <div className="flex-1">
                ...
                {!deviceToken ? (
                  <button
                    ...
                    disabled={loading}
                    className="px-6 py-3 bg-cyan-400 text-black font-bold hover:bg-cyan-300 rounded transition-colors disabled:opacity-50"
                  >
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      onClick={copyToken}
                      className="px-4 py-2 border border-cyan-400/30 text-cyan-400 rounded hover:bg-cyan-400/10 transition-colors inline-flex items-center gap-2"
                    >
                      {copied ? (
                        <>
